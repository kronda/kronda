<?php
/**
 * Builds out the sidebar postal theme.
 *
 ...
 * @since        1.0.0
 */
class optin_monster_build_sidebar_postal_theme {
	...
	public function build() {
		...
		html div#om-' . $this->hash . ' #om-sidebar-' . $this->theme . '-left.om-has-image #om-sidebar-' . $this->theme . '-optin-image-container {
			width: 25%;
		}
		...
		$content_bg_color = $this->get_field( 'background', 'content' );
