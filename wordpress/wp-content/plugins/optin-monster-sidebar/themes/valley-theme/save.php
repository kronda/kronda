<?php
/**
 * Saves the post optin "Valley Theme".
 *
 ...
 * @since        1.0.0
 */
class optin_monster_save_sidebar_valley_theme {
	...
	public function save_optin() {
		...
		if ( empty( $this->meta['content']['video'] ) )
			$this->meta['content']['video'] = isset( $this->data['optin_video'] ) ? wp_kses_post( $this->data['optin_video'] ) : '';
		else
			$this->meta['content']['video'] = isset( $this->data['optin_video'] ) ? wp_kses_post( $this->data['optin_video'] ) : $this->meta['content']['video'];
