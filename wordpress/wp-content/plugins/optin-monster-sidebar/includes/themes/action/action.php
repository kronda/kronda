 ...
 */
class Optin_Monster_Sidebar_Theme_Action extends Optin_Monster_Theme {
        ...
        $html = '<div id="om-' . $this->type . '-' . $this->theme . '-optin" class="om-' . $this->type . '-' . $this->theme . ' om-clearfix om-theme-' . $this->theme . ' ' . ( $provider && 'custom' == $provider ? 'om-custom-html-form' : '' ) . '" style="background-color:' . $this->get_background_setting( 'content', '#fff' ) . '">';
            $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-optin-wrap" class="om-clearfix">';
                ...
                $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-header" class="om-clearfix" data-om-action="selectable">';
                    $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-optin-title" data-om-action="editable" data-om-field="title" style="' . $this->get_element_style( 'title', array( 'color' => '#222222', 'font' => 'Helvetica', 'size' => '18px' ) ) . '">' . $this->get_title_setting( 'text', __( 'OptinMonster is the #1 lead generation platform for WordPress.', 'optin-monster-sidebar' ) ) . '</div>';
                $html .= '</div>';
    ...
    public function design_fields( $fields, $instance ) {
        ...
        $fields['content_bg'] = $instance->get_color_field(
            ...
            __( 'Background Color', 'optin-monster-sidebar' ),
            __( 'The background color of the optin.', 'optin-monster-sidebar' ),
            '',
            array(
