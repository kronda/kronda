 ...
 */
class Optin_Monster_Sidebar_Theme_Postal extends Optin_Monster_Theme {
    ...
    public function get_styles() {
        ...
        html div#om-' . $this->optin->post_name . ' #om-' . $this->type . '-' . $this->theme . '-top.om-has-image #om-' . $this->type . '-' . $this->theme . '-optin-tagline {
            width: 75%;
            padding-left: 15px;
        }
        ...
        html div#om-' . $this->optin->post_name . ' #om-' . $this->type . '-' . $this->theme . '-top.om-has-image #om-' . $this->type . '-' . $this->theme . '-optin-image-container {
            width: 25%;
        }
    ...
    public function get_html() {
        ...
        $html = '<div id="om-' . $this->type . '-' . $this->theme . '-optin" class="om-' . $this->type . '-' . $this->theme . ' om-clearfix om-theme-' . $this->theme . ' ' . ( $provider && 'custom' == $provider ? 'om-custom-html-form' : '' ) . '">';
            $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-optin-wrap" class="om-clearfix">';
                ...
                // Header area.
                $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-header" class="om-clearfix" data-om-action="selectable" data-om-target="#optin-monster-field-header_bg" style="background-color:' . $this->get_background_setting( 'header', '#50bbe8' ) . '">';
                ...
                $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-content" class="om-clearfix" data-om-action="selectable" data-om-target="#optin-monster-field-content_bg" style="' . $this->get_background_setting( 'content', '#fbfdf3' ) . '">';
                    ...
                    $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-top" class="' . $image_class . '">';
                        // Image container
                    ...
                    $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-bottom" class="' . $class_name . '">';
