<?php
/**
 * Saves the post optin "Banner Theme".
 *
 ...
 * @since        1.0.0
 */
class optin_monster_save_post_banner_theme {
	...
	public function save_optin() {
		...
		if ( empty( $this->meta['header']['border_color'] ) )
			$this->meta['header']['border_color'] = isset( $this->data['optin_header_border_color'] ) ? esc_attr( $this->data['optin_header_border_color'] ) : '';
		else
			$this->meta['header']['border_color'] = isset( $this->data['optin_header_border_color'] ) ? esc_attr( $this->data['optin_header_border_color'] ) : $this->meta['header']['border_color'];
