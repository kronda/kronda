<?php
/**
 * Builds out the ligthbox postal theme.
 *
 ...
 * @since        1.0.0
 */
class optin_monster_build_lightbox_postal_theme {
	...
	public function build() {
		...
		html div#om-' . $this->hash . ' #om-lightbox-' . $this->theme . '-optin-wrap {
			position: relative;
			height: 100%;
			background: url(' . plugins_url( 'inc/css/images/postal-border.png', $this->base->file ) . ') 50% 0 no-repeat,
				url(' . plugins_url( 'inc/css/images/postal-border.png', $this->base->file ) . ') 50% 100% no-repeat;
		}
		html div#om-' . $this->hash . ' #om-close {
			...
			height: 16px;
			display: block;
			background: url(' . plugins_url( 'inc/css/images/postal-close.png', $this->base->file ) . ') no-repeat scroll 0 0;
		}
		...
		$theme .= '<div id="om-lightbox-' . $this->theme . '-optin" class="om-lightbox-' . $this->theme . ' om-clearfix ' . ( isset( $this->meta['email']['provider'] ) && 'custom' == $this->meta['email']['provider'] ? 'om-custom-html-form' : '' ) . '">';
			$theme .= '<div id="om-lightbox-' . $this->theme . '-optin-wrap" class="om-clearfix">';
				...
				$theme .= '<div id="om-lightbox-' . $this->theme . '-footer" class="om-clearfix' . $class . '">';
				    if ( isset( $this->meta['email']['provider'] ) && 'custom' == $this->meta['email']['provider'] ) :
					    ...
					    if ( ! empty( $submit['border_color'] ) )
						    $style .= 'border-color:' . $submit['border_color'] . ';';
