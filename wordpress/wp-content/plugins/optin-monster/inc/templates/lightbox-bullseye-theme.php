<?php
/**
 * Builds out the ligthbox bullseye theme.
 *
 ...
 * @since        1.0.0
 */
class optin_monster_build_lightbox_bullseye_theme {
	...
	public function build() {
		...
		html div#om-' . $this->hash . ' #om-lightbox-' . $this->theme . '-content {
			...
			margin: 0;
			padding: 0;
			background: ' . ( 'customizer' == $this->env ? '#fff url(' . plugins_url( 'inc/css/images/image-holder.png', $this->base->file ) . ') no-repeat scroll 50% 50%;' : '#fff;' ) . '
		}
