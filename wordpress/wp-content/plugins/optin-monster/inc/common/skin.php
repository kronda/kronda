...
/**
 * Addons skin class for OptinMonster
 *
 * @since 1.2.0
 *
 ...
 */
class optin_monster_skin extends WP_Upgrader_Skin {
	...
	function error( $errors ) {
		...
		if ( ! empty( $errors ) )
			echo json_encode( array( 'error' => __( 'There was an error installing the addon. Please try again.', 'optin-monster' ) ) );
