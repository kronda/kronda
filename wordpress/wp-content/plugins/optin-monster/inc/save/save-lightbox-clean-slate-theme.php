<?php
/**
 * Saves the lightbox optin "Clean Slate Theme".
 *
 ...
 * @since        1.0.0
 */
class optin_monster_save_lightbox_clean_slate_theme {
	...
	public function save_optin() {
		...
		if ( empty( $this->meta['background']['border'] ) )
		    $this->meta['background']['border'] = isset( $this->data['optin_border_bg'] ) ? esc_attr( $this->data['optin_border_bg'] ) : '';
		else
		    $this->meta['background']['border'] = isset( $this->data['optin_border_bg'] ) ? esc_attr( $this->data['optin_border_bg'] ) : $this->meta['background']['border'];
        ...
        // Save optin background colors.
		if ( empty( $this->meta['background']['footer_border'] ) )
		    $this->meta['background']['footer_border'] = isset( $this->data['optin_footer_border'] ) ? esc_attr( $this->data['optin_footer_border'] ) : '';
		else
		    $this->meta['background']['footer_border'] = isset( $this->data['optin_footer_border'] ) ? esc_attr( $this->data['optin_footer_border'] ) : $this->meta['background']['footer_border'];
        ...
        if ( empty( $this->meta['bullet']['arrow_color'] ) )
		    $this->meta['bullet']['arrow_color'] = isset( $this->data['optin_bullet_arrow_color'] ) ? esc_attr( $this->data['optin_bullet_arrow_color'] ) : '';
		else
		    $this->meta['bullet']['arrow_color'] = isset( $this->data['optin_bullet_arrow_color'] ) ? esc_attr( $this->data['optin_bullet_arrow_color'] ) : $this->meta['bullet']['arrow_color'];
