<?php
/**
 * Saves the lightbox optin "Chalkboard Theme".
 *
 ...
 * @since        1.0.0
 */
class optin_monster_save_lightbox_chalkboard_theme {
	...
	public function save_optin() {
        ...
        // Save optin background colors.
		if ( empty( $this->meta['background']['body'] ) )
		    $this->meta['background']['body'] = isset( $this->data['optin_body_bg'] ) ? esc_attr( $this->data['optin_body_bg'] ) : '';
		else
		    $this->meta['background']['body'] = isset( $this->data['optin_body_bg'] ) ? esc_attr( $this->data['optin_body_bg'] ) : $this->meta['background']['body'];
