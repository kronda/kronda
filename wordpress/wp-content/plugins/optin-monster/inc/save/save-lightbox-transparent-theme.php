<?php
/**
 * Saves the lightbox optin "Bullseye Theme".
 *
 ...
 * @since        1.0.0
 */
class optin_monster_save_lightbox_transparent_theme {
	...
	public function save_optin() {
		...
		$this->meta['fonts'] = array( $this->meta['name']['font'], $this->meta['email']['font'], $this->meta['submit']['font'] );
