...
/*abstract*/ class base_wp_option {
	...
	function set_value($value) {
	    $this->value = get_magic_quotes_gpc() ? $value : stripslashes_deep($value);
	}
...
class wp_option_textarea extends wp_option {
	...
	function render() {
		$field_html = '<textarea name="' . $this->name . '" id="' . $this->name . '" ' . $this->get_custom_attrs() . '>' . htmlentities($this->value) . '</textarea>';
	    return wp_option::render($field_html);
	}
}
