...
?>
	...
	<footer id="colophon" role="contentinfo">
	  <?php if ( is_front_page() ): //only show the busymeter on the front page ?> 
	  <div id="busymeter" class="footercolumn">
		...
		<?php endif; ?> <!-- if front page show busymeter -->
    ...
    <div id="widgets">
        <div id="supplementary" class="three">
          ...
          <aside id="social" class="widget widget_links">
            <h3>My Hangouts</h3>
  					<ul>
          ...
          <aside id="blogteaser" class="footercolumn widget">
            <h3>From The Blog</h3>
            <?php show_featured_post($PreFeature = '', $PostFeature = '', $AlwaysShow = false); ?>
          </div><!-- aside blogteaser -->
        </div><!-- second -->
						
 				<div id="third" class="widget-area" role="complementary">
          <aside id="tweet" class="footercolumn widget">
