		   	...
		   	<ul class="slides">				
				<li id="jillmalone" class="case_study">
					<div class="img_holder">
						<a href="http://www.jillmalone.com"><img src="images/jillmalone.jpg" alt="Jill Malone thumbnail" title="Take me to the site!"></a>
					</div><!-- img_holder -->
				...
				<li id="waronpink" class="case_study">
					<div class="img_holder">
						<a href="http://waronpink.kronda.com"><img src="images/waronpink.jpg" alt="War on Pink thumbnail" title="Take me to the site!"></a>
					</div><!-- img_holder -->
					<div class="checkboxes">
						<dl class="checks">
							<dt>HTML</dt>
				...
				<li id="sorella" class="case_study">
					<div class="img_holder">
						<a href="http://www.sorellaforte.com"><img src="images/sorellaforte.jpg" alt="Sorella Forte thumbnail" title="Take me to the site!"></a>
					</div><!-- img_holder -->
				...
				<li id="checafe" class="case_study">
					<div class="img_holder">
						<a href="http://www.checafepdx.com"><img src="../wp-content/themes/kronda/images/checafe.jpg" alt="Che Cafe thumbnail" title="Take me to the site!"></a>
					</div><!-- img_holder -->
				...
				<li id="trendless" class="case_study">
					<div class="img_holder">
						<a href="http://trendlesspdx.kronda.com"><img src="images/trendless.jpg" alt="Trendless thumbnail" title="Take me to the site!"></a>
					</div><!-- img_holder -->
